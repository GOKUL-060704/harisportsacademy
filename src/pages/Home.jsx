...
const gradients = [
  'from-[#0000FE]/70 to-red-500/70',
  'from-emerald-600/70 to-blue-600/70',
  'from-purple-600/70 to-pink-600/70',
  'from-orange-500/70 to-rose-500/70',
  'from-indigo-600/70 to-cyan-500/70'
];
      ...
      <section className="relative h-[90vh] flex items-center justify-center overflow-hidden">
        ...
        <AnimatePresence mode="wait">
          <motion.div
            ...
            className={`absolute inset-0 bg-gradient-to-r ${gradients[currentGradient]}`}
          />
        </AnimatePresence>
